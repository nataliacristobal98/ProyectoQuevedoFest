...
#### 4. Mostrar los datos de los solistas que actuan junto a Rosalía
...
#### 6. Mostrar los artistas que aperecen en el cartel creado por Mario Lería
...
(4 rows)
```
 -Si cambiasemos la agencia de por ejemplo Zendaya:
```sql
...
#### 9. Los datos de los spekears que dan las charlas de Tarot y choques culturales y de su presentador corespondiente
...
#### 14. Muestre los cantantes que sean grupos, que hayan debutado despues de 2014 pero su género de música no sea pop. Tambien tiene que aperecer en el cartel del 3 día
...
#### 15. ¿Hay algun estilista que sea de vestuario y maquillaje a la vez?
